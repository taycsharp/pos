...
userRoutes.get("/", authorize("read-user"), getAllUser); // readUser only
userRoutes.get("/:id", authorize("read-user"), getSingleUser); // authenticated users can read their own and readUser
